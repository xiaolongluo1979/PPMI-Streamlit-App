...
# Import from alphaTrials (assuming it's in the same directory structure)
...
with tab3:
    ...
    if st.session_state.baseline_data and st.session_state.longitudinal_data:
        ...
        with col1:
            ...
            st.success("✅ Baseline data ready for download")
        ...
        with col2:
            ...
            st.success("✅ Longitudinal data ready for download")
